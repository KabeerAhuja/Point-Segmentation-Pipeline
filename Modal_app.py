...
def build_point_rallies(
    ...
    for entry in frames_data:
        ...
        if frame is not None:
            ...
            player_pos_by_frame[frame] = {
                "player_1": {
                    "world_x": p1_data.get("world_x") if p1_data else None,
                    "world_y": p1_data.get("world_y") if p1_data else None,
                },
                "player_2": {
                    "world_x": p2_data.get("world_x") if p2_data else None,
                    "world_y": p2_data.get("world_y") if p2_data else None,
                },
            }
    ...
    for i, point in enumerate(points_sorted):
        ...
        for shot_idx, shot in enumerate(point_shots):
            ...
            for bounce in bounces_after_hit:
                ...
                bounce_info = {
                    "x": round(bounce.get("ball_court_x", 0), 2) if bounce.get("ball_court_x") else None,
                    "y": round(bounce.get("ball_court_y", 0), 2) if bounce.get("ball_court_y") else None,
